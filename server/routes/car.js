...
router.post('/create',
    [
        body('model')
            .trim()
            .isLength({ min: 1 })
            .withMessage('Car model is requaird.'),
        body('imageUrl')
            .trim()
            .isLength({ min: 1 })
            .withMessage('Car imageUrl is requaird.'),
            ...
            .custom((value, { req }) => {
                ...
                if (isNumber) {
                    if (parseFloat(+value) < 0.1) {
                        return Promise.reject('Car priceForDayRent must be be more then 0.1');
                    }
        ...
        body('horsePower')
            ...
            .custom((value, { req }) => {
                ...
                if (isNumber) {
                    if (parseFloat(+value) < 0.1) {
                        return Promise.reject('Car horsePower must be be more then 0.1');
                    }
        ...
        body('fuelCapacity')
            ...
            .custom((value, { req }) => {
                ...
                if (isNumber) {
                    if (parseFloat(+value) < 0.1) {
                        return Promise.reject('Car fuelCapacity must be be more then 0.1');
                    }
        ...
        body('kilometersTraveld')
            ...
            .custom((value, { req }) => {
                ...
                if (isNumber) {
                    if (parseFloat(+value) < 0.1) {
                        return Promise.reject('Car kilometersTraveld must be be more then 0.1');
                    }

                    return true;
                } else {
                    return Promise.reject('Car kilometersTraveld need to be a number');
                }
            })
